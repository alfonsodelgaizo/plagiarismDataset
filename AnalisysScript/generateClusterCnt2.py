...
## -->>> python3 generateClusterCnt2.py NomeAlgoritmo TipoEmbedding <<<----
...
def generateCSV():
    ...
    with open('./Results_2_General/'+algo+'/coupleCnt_'+embedding+'.csv', 'w') as csvfile:
...
for j in range(0,len(coupleArray)):
   ...
   folderRead('./Results_2/'+algo+'/'+embedding+'/',song1,song2)
   i=i+1
...
sys.argv = ['./plottingTest2.py',algo,embedding]
exec(open("./plottingTest2.py").read())