#Script che presi in input l'algoritmo, il numero di cluster in cui si vuole dividere lo spazio e il tipo di embedding
# crea uno ScatterPlot in cui si possono notare i cluster colorati opachi e le coppie che sono effettivamente plagio
# marcate di rosso.

# ----->>>> python3 scatterPlot_2.py Kmean 23 150   <<<----
...
def modificaLabelColor():
    with open('./Results_2/'+algo+'/'+embedding+'/clusteCoupler'+n_clusterString+'.csv') as csv_file:
